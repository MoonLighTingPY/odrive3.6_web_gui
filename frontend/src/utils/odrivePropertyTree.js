      ...
      motor: {
        ...
        children: {
          current_control: {
            ...
            properties: {
              p_gain: { name: 'P Gain', description: 'Current controller proportional gain', writable: true, type: 'number', decimals: 6, hasSlider: true },
              i_gain: { name: 'I Gain', description: 'Current controller integral gain', writable: true, type: 'number', decimals: 6, hasSlider: true },
        ...
        children: {
          config: {
            ...
            properties: {
              ...
              offset: { name: 'Offset', description: 'Encoder offset (counts)', writable: true, type: 'number', decimals: 3, hasSlider: true },
